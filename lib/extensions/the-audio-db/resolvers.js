...
exports.default = {
  TheAudioDBArtist: {
    ...
    fanArt: handleImageSize(artist => {
      return [artist.strArtistFanart, artist.strArtistFanart2, artist.strArtistFanart3].filter(Boolean);
    }),
  ...
  TheAudioDBMusicVideo: {
    ...
    screenshots: handleImageSize(track => {
      return [track.strMusicVidScreen1, track.strMusicVidScreen2, track.strMusicVidScreen3].filter(Boolean);
    }),
