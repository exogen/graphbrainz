...
class CoverArtArchiveClient extends _client2.default {
  constructor({
  ...
  imageURL(entityType, mbid, typeOrID = 'front', size) {
    ...
    return this.get(url, { method: 'HEAD', followRedirect: false }).then(headers => headers.location);
  }
}
exports.default = CoverArtArchiveClient;