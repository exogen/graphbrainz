...
exports.ReleaseGroupType = exports.ReleaseStatus = exports.CoverArtImageSize = exports.ArtistType = undefined;

var _type = require('graphql/type');

const ArtistType = exports.ArtistType = new _type.GraphQLEnumType({
  name: 'ArtistType',
...
const CoverArtImageSize = exports.CoverArtImageSize = new _type.GraphQLEnumType({
...
const ReleaseStatus = exports.ReleaseStatus = new _type.GraphQLEnumType({
  name: 'ReleaseStatus',
...
const ReleaseGroupType = exports.ReleaseGroupType = new _type.GraphQLEnumType({
